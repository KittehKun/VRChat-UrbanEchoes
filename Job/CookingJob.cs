...
public class CookingJob : UdonSharpBehaviour
{
	...
	[SerializeField] private Transform goalPointsIngredients; // Set in Unity Inspector | Contains all the goal points where the player must place the ingredients.
